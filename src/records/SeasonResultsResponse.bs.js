...
var RaceTable$FincompareFrontendChallenge = require("./RaceTable.bs.js");
...
function decodeMRDataUnsafe(json) {
  return /* record */[
          ...
          /* raceTable */Json_decode.optional((function (param) {
                  return Json_decode.field("RaceTable", RaceTable$FincompareFrontendChallenge.decodeRaceTableUnsafe, param);
                }), json)
        ];
}
                    ...
                    /* :: */[
                      ...
                      /* :: */[
                        ...
                        /* :: */[
                          /* tuple */[
                            "RaceTable",
                            Json_encode.nullable(RaceTable$FincompareFrontendChallenge.encodeRaceTable, mrdataItem[/* raceTable */6])
                          ],
                          /* [] */0
                        ]
                      ]
...
function decodeResponse(json) {
  try {
    ...
    return /* Error */Block.__(1, ["Error in decoding JSON to: SeasonResultsResponse"]);
  }
}
